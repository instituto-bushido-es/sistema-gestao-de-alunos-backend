...
class AlunoControllerTest {
    ...
    void setUp() {
        ...
        aluno.setRg("RG");
        aluno.setCorDePele(CorDePele.BRANCO.name());
        aluno.setTelefone("TELEFONE");
        aluno.setDataNascimento(new Date().getTime());
        aluno.setDadosEscolares(new DadosEscolares("ESCOLA", Turno.MANHA, "1"));
        ...
        alunoDTORequest = AlunoDTORequest.builder()
                ...
                .withGenero(aluno.getGenero().name()).withTurma(aluno.getTurma())
                .withCorDePele(aluno.getCorDePele().name())
    ...
    void deveAdicionarFaltaAoAluno() {
        ...
        FaltaDTORequest faltaDTORequest = new FaltaDTORequest("Motivo", true);
