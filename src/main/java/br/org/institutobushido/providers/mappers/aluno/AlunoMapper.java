...
public class AlunoMapper {
        ...
        private static Aluno mapCommonFieldsToAluno(AlunoDTOResponse alunoDTOResponse) {
                ...
                aluno.setGenero(alunoDTOResponse.genero() != null ? alunoDTOResponse.genero().name() : "");
                ...
                aluno.setCorDePele(alunoDTOResponse.corDePele() != null ? alunoDTOResponse.corDePele().name() : "");
