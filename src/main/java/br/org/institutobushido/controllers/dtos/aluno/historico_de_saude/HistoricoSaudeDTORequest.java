...
public record HistoricoSaudeDTORequest(
        @Pattern(regexp = "^(B_POSITIVO, A_POSITIVO, O_POSITIVO, B_NEGATIVO, A_NEGATIVO, O_NEGATIVO, AB_POSITIVO, AB_NEGATIVO)$", message = "Tipo Sanguineo inválido!") TipoSanguineo tipoSanguineo,
